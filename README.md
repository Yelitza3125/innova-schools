...
Para realizar el reto, se investigó sobre los métodos tradicionales que se suelen usar para orientar a los estudiantes en la elección de su carrera profesional. Además se consideró necesario entrevistar a otras personas sobre su experiencia durante el tránsito entre la escuela y su vida profesional.

Se decidió dar un enfoque desde la perspectiva de las experiencias. Es decir, de personas que ya están trabajando o estudiando en alguna universidad y conocer como vivieron el proceso de decidir que carrera elegir. Con el fin de encontrar un punto de convergencia y proponer una solución que funcione y que se aleje de posibles errores cometidos en los métodos de orientación vocacional tradicionales. 

## **Research**


#### Análisi del libro: *¿El mito sigue vivo? Privatización y diferenciación social de la educación peruana.* 
...
Una cita textual relevante para la realización del reto es:
...
En otra parte se señala uno de los objetivos de la escuela: preparar a los estudiantes para ser alguien, pero que sean ellos quienes decidan qué quieren ser. Reafirmando esto se define que las expectativas de los padres ya no es solo la vida universitaria para sus hijos, si no también la creación de empresas propias. En general, superar retos y la independencia.

Esto indica un cambio de modelo social, ahora los padres ven la educación como un factor determinante de superación y estatus. 


### Proyecto Off Road

Proyecto de la Universidad Torcuato Di Tella,  que buscaba ayudar a los estudiantes de secundaria a decidir su futuro.
...
Buscaron que los jóvenes se pregunten qué es lo que quieren ser en su vida, y no sólo qué carrera elegir. Durante el tiempo que duró el proyecto, trabajaron con más de 700 jóvenes.
...
Algunas de las profesiones preferidas por este grupo de personas: jardinería, mecánica, arquitectura, cocina, policía, conductor, ingeniería.

 
2. **Investigador**, tiene preferencia por trabajar en entornos intelectuales en los que maneja ideas abstractas y símbolos. Se aleja de ambientes comerciales y prefiere actividades que implican analizar, pensar, organizar y comprender.

Algunas de las profesiones preferidas por este grupo de personas: matemáticas, química, docencia, informática, farmacia.
 
3. **Artístico**, con preferencia por las actividades que permitan la expresión creativa. Suelen ser personas muy independientes, originales, poco conformistas, poco convencionales y a veces incluso caóticas. Su personalidad se pone de manifiesto en ambientes profesionales y ocupaciones artísticas como pintura, diseño gráfico, música, literatura, estética y peluquería, arte dramático, literatura.
...
Se encontro similitudes entre las tres personas, a pesar de la diferencia de edad. Las mismas se ennumeran a continuación:

1. Las actividades sobre orientación vocacional realizadas por en sus colegios fueron: ferias vocacionales y test vocacionales.

2. Han buscados test vocacionales por Internet.

3. Opinan que los test vocacionales son largos, con preguntas que se repiten y terminan por ser aburridos.

4. Los resultados que obtuvieron del test fueron aburridos.

5. Consideran que las ferias vocacionales realizadas, solo eran un espacio de promoción para las universidades e institutos.
...
- ¿Cómo podríamos orientar al estudiante sin influir en su decisión?
- ¿Cómo podríamos involucrar aptitudes, habilidades e intereses?
- ¿Cómo podríamos crear una solución que fomente el trabajo en equipo?


### Oportunidades:

Oportunidades surgidas a través de los problemas encontrados.

- Orientar al estudiante mediante actividades recreativas y productivas.
- Generar ambientes de trabajo que fomente el trabajo en equipo. 
- Aprovechar el uso de la tecnología para crear herramientas de seguimiento y orientación del estudiante. 

## **Propuesta de solución**:

Una platoforma virtual para los estudiantes donde puedan medir su desempeño académico y cómo se sintieron en cada unidad de aprendizaje. Además de acuerdo a lo aprendido, se le proponen actividades y juego de roles relacionados con profesiones.
...
Para la solución se tomaron como base 3 conceptos: La metodología Blending, el proyecto Off Road y el Modelo RIASEC.

1. De la metodología Blending Learning, se aprovecha el trabajo colaborativo y el aprendizaje mediante la tecnología.
...
3. El Modelo RIASEC, se utiliza para determinar cuáles son los intereses y motivaciones profesionales que se ajusten más a la personalidad del estuiante.  
